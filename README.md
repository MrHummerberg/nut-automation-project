...
> **Nota sobre distribuciones Linux modernas:** En Debian 12+, Ubuntu 23.04+, Federror: externally-managed-environment
...
ora 38+ y otras distros recientes, `pip install` puede mostrar el error `externally-managed-environment`. Esto se debe a PEP 668 que protege los paquetes del sistema. Usa una de las opciones siguientes:
